const { EMAIL_BUTTON_BACKGROUND_COLOR, EMAIL_BUTTON_TEXT_COLOR, TEXT_COLOR, BACKGROUND_COLOR, CARD_BACKGROUND_COLOR, FONT_FAMILY } = require('./node_prisma.template_colors.json');
const { FRONT_BASE_URL, LOGO_URL, APP_NAME, EMAIL_BACKGROUND_COLOR, EMAIL_CARD_BACKGROUND_COLOR, EMAIL_FONT_FAMILY, EMAIL_TEXT_COLOR, EMAIL_BUTTON_BACKGROUND_COLOR_IN_ENV, EMAIL_BUTTON_TEXT_COLOR_IN_ENV, } = require("../../config/node_prisma.constants");
